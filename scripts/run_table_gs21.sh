#!/usr/bin/env bash
# Gaussian-splat-on-mesh training for data/table, run 21.
#
# ONE flag changes from gs20: coverage_floor_target 1.0 -> 0.7
#
# ---------------------------------------------------------------------------------------
...
#   bash scripts/run_table_gs21.sh
#   bash scripts/run_table_gs21.sh --export-only
